...
public class HelloWorldController{
	...
	public void initBinder(WebDataBinder binder){
		...
		binder.registerCustomEditor(Date.class, "studentDOB", new CustomDateEditor(simple, false));
	}
	...
	public ModelAndView helloWorld_modelAttribute(@ModelAttribute("studentobj") Student studentobj , BindingResult bindresult){
		System.out.println("In submitForm1");
